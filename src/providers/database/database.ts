...
export class DatabaseProvider {
  ...
  addDeveloperSoc(fp_id, user_id,auth_token_tw,oauth_token_secret_tw,user_id_soc_tw){
    let data = [fp_id, user_id,auth_token_tw,oauth_token_secret_tw,user_id_soc_tw];
    return this.database.executeSql("INSERT INTO user (fp_id,user_id,auth_token_tw,oauth_token_secret_tw,user_id_soc_tw) VALUES (?,?,?,?,?)",data).then(res =>{
      return res;
    })
  }
